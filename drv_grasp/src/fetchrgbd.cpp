...
void FetchRGBD::initRGBDCallback()
{
  ...
  sub_rgb_.subscribe(*rgb_it_, "/vision/rgb/image_rect_color", 5, TransportHints("compressed"));
  sub_depth_.subscribe(*depth_it_, "/vision/depth/image_rect", 5, TransportHints("compressedDepth"));
